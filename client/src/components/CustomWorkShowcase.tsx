      ...
      <div className="container mx-auto px-4">
        ...
        {loading ? (
          <div className="text-center py-12">
            <p className="text-[#73946B]">Loading projects...</p>
          </div>
        ) : projects.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-[#73946B]">No projects found. Please check the console for debugging information.</p>
          </div>
        ) : (
            ...
            {projects.map((project) => {
              ...
              return (
                <div key={project.id} className="bg-[#F9F5E7] rounded-lg overflow-hidden shadow-md">
                  ...
                  <div className="p-6">
                    <h3 className="font-playfair font-bold text-xl text-[#73946B] mb-2">
                      {project.Title}
                    </h3>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xs bg-white px-3 py-1 rounded-full text-[#73946B]">
                        {project.Category}
                      </span>
        ...
        <div className="text-center mt-12">
          <a 
            ...
            className="inline-block px-8 py-3 bg-[#73946B] hover:bg-[#4A3C2A] text-white font-medium rounded-md transition duration-300"
          >
            View Portfolio
          </a>
        </div>
